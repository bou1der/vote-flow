...
export function SearchFilters(){
  ...
  const [query, setQuery] = useState<VotingStatus | null>(searchParams.get("status") as VotingStatus | null)
  ...
  return (
    <div className="w-full h-10 border-b border-white/40 flex flex-row items-stretch gap-6">
      <div
        className={cn("flex items-center cursor-pointer transition-all",
