	...
	return (
		<DayPicker
			...
			classNames={{
				...
				day_range_start: "day-range-start aria-selected:bg-primary aria-selected:text-background",
				day_range_end: "day-range-end aria-selected:bg-primary aria-selected:text-background",
				day_selected:
